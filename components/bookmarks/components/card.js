    ...
    return (
        <li key={`${data.link}-${data.key}`}>
            <article className="hover:bg-gray-800 transition duration-350 ease-in-out">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                                <p className="text-base leading-6 font-medium text-white">
                                    Osman Abi
                                    <span className="pl-1 text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                                        @OsmanAbi  . 13 June
                                    </span>
                                </p>
                            </div>
                ...
                <div className="pl-16">
                    <p className="flex flex-col text-base width-auto font-medium text-white flex-shrink">
                        <span>{data.desc}</span>
                        <a className='cursor-pointer' target='_blank' href={`https://${data.link}`} rel='noopener noreferrer'>{data.link}</a>
                    </p>
                    <div className="md:flex-shrink pr-6 pt-3">
                        <div className="bg-cover bg-no-repeat bg-center rounded-lg w-full h-64" style={{ height: '200px' }}>
                            <img className=" w-full h-full" src="/mock.png" alt="" />
                        </div>
                    </div>
